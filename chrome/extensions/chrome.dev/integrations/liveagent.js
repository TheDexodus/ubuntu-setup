clockifyButton.render('.ConversationDetailsView:not(.clockify)', { observe: true }, (ticketSidebar) => {
...
clockifyButton.render('.ArticleDetails:not(.clockify)', { observe: true }, (articleDetails) => {

  const articleHeader = $('.ArticleContentView .DialogTitle').textContent.trim();
