clockifyButton.render('.item-field-name input:not(.clockify)', {observe: true}, () => {
    var link, titleText,
...
clockifyButton.render('.axo-view-item-content .item-field-name:not(.clockify)', {observe: true}, () => {
    var link, titleText,
