...
clockifyButton.render('.entity-wrap:not(.clockify)', { observe: true }, function (elem) {
...
clockifyButton.render('.app-container:not(.clockify)', { observe: true }, function (elem) {
...
clockifyButton.render('.ember-modal-header:not(.clockify)', { observe: true }, function (elem) {
