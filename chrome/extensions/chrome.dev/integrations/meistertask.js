...
clockifyButton.render('.js-box-wrapper:not(.clockify)', {observe: true}, (elem) => {
    ...
    clockifyButtonElement = $('.js-task-header>div>row>cell:nth-child(5)', elem);
...
clockifyButton.render('.knightrider-lazyscrollview-item:not(.clockify)', {observe: true}, (elem) => {
    var link, 
